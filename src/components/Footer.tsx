        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="flex justify-center md:justify-start">
            <div className="flex flex-col items-center space-y-5 border-x border-white/30 px-5">
              <Link
                href="https://www.facebook.com/InnovativeBiscuits/"
                target="blank"
              >
                <Facebook className="w-[80px] h-[45px]" />
              </Link>
              <Link
                href="https://www.instagram.com/innovative.biscuits/"
                target="blank"
              >
                <Instagram className="w-[80px] h-[40px]" />
              </Link>
              <Link href="https://x.com/innovativebis" target="blank">
                <svg
              ...
              <Link
                href="https://www.youtube.com/@innovativebiscuits1478"
                target="blank"
              >
                <Youtube className="w-[80px] h-[40px]" />
              </Link>
              <Link
                href="https://www.linkedin.com/company/innovative-biscuits-pvt.-ltd/posts/?feedView=all"
                target="blank"
              >
