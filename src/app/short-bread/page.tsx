    ...
    <div className="overflow-hidden">
      <div className="relative w-full bg-[#ffa372] pb-10">
        ...
        <Image
          ...
          alt="digestive-copy"
          className="hidden md:block absolute w-[35%] left-[-4rem] md:left-[-18rem] top-[40rem] bottom-0 my-auto"
        />
        <div className="flex flex-col px-10 md:px-30 mt-0 md:mt-12">
          ...
          />
          <div className="flex flex-col items-center mt-5 md:mt-20 md:px-34 gap-10">
            <div>
            ...
            <Image
              src={shortBread}
              alt="boxes-image"
              className="w-[60%] md:w-[35%] mb-5 md:mb-0"
            />
          </div>
        </div>
