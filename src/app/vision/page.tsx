    ...
    <div>
        ...
        <div className='flex flex-col gap-5 text-white text-center md:text-left'>
          <div className='flex'>
            ...
            <div className='hidden md:flex p-15 items-center w-[60%] bg-[#fd9b6c] text-lg md:text-3xl text-[#8e2e19]'>
          ...
          <div className='flex'>
            <div className='hidden md:flex p-15 items-center w-[60%] bg-[#5899af] text-lg md:text-3xl'>
              <ul className='list-disc'>
          ...
          <div className='flex'>
            ...
            <div className='hidden md:flex p-15 items-center w-[60%] bg-[#df9f3e] text-lg md:text-3xl'>
              <ul className='list-disc'>
        ...
        <div className='flex mt-15 mb-25 text-white'>
            ...
            <div className='hidden md:block md:w-[60%] bg-[#5899af] p-25'>
                <p className='text-lg md:text-2xl pt-5 pb-11 border-b'>
