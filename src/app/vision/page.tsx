...
export default function LandingPage() {
    ...
    <div>
        <div
          ...
          className="text-white w-full bg-no-repeat bg-center md:bg-cover">
              ...
              <div className="flex flex-col gap-4 items-center text-center font-black mx-5 md:mx-30  py-25 md:py-75">
                  <div className="text-2xl md:text-6xl whitespace-pre-line">{`Where Every Bite\nBrings a Smile`}</div>
              </div>
        </div>
        ...
        <div className='flex flex-col my-15 md:m-30'>
            ...
            <p className='text-base md:text-2xl my-2 md:my-10 px-5 md:px-25 text-center'>We take this joy seriously — and that means <strong>responsibility at every step:</strong></p>
        </div>
