                  ...
                  <div className='flex flex-col gap-5 text-white md:text-left'>
                    <div className='flex'>
                      <div className='flex flex-col w-full md:w-[60%] bg-[#6b9ebd] p-15'>
                        <div className="text-base md:text-xl font-medium">THE HONORABLE CHAIRMAN</div>
                        <div className="text-xl md:text-4xl font-black mt-2 md:mt-5 mb-5 md:mb-10">SHEIKH MUNIR HUSSAIN</div>
                        <div className="text-lg md:text-2xl font-semibold">GET TO KNOW+</div>
                      </div>
                    ...
                    <div className='flex'>
                      ...
                      <div className='flex flex-col w-full md:w-[60%] bg-[#fd9b6c] p-15'>
                        <div className="text-base md:text-xl font-medium">THE MANAGING DIRECTOR</div>
                        <div className="text-xl md:text-4xl font-black mt-2 md:mt-5 mb-5 md:mb-10">MR. AAMIR RAZA</div>
                        <div className="text-lg md:text-2xl font-semibold">GET TO KNOW+</div>
                      </div>
                    </div>
                  </div>
