  ...
  return (
    <div>
      <div className="w-full bg-no-repeat bg-center md:bg-cover">
        ...
        <div className="flex flex-col gap-4 items-center text-center font-black mx-6 md:mx-30">
          <div className="text-2xl md:text-6xl mt-12 md:mt-40 whitespace-pre-line">{`Leadership that\ninspires innovation.`}</div>
          <div className="text-lg md:text-4xl my-6 mb-10 md:my-10 md:my-15 md:mb-25 border-b border-b-[1.5px] border-b-[#000000] pb-2">
            {" "}
            Our Leadership
          </div>
        </div>

        <div className="flex flex-col gap-0 md:gap-5 text-white md:text-left">
          <div className="flex flex-col md:flex-row">
            <div className="flex flex-col w-full md:w-[40%] bg-[#6b9ebd] p-6 md:p-15">
            ...
            <div className="min-h-[25rem] p-6 md:p-15 md:w-[60%] bg-[#123a5e]">
          ...
          <div className="flex flex-col-reverse md:flex-row">
            ...
            <div className="flex flex-col w-full md:w-[40%] bg-[#fd9b6c] p-6 md:p-15">
              <div className="text-base md:text-xl font-medium">
