    ...
    <div>
      ...
      <div className="flex flex-col items-center relative text-center p-6 md:p-15 md:px-50 md:py-20">
        ...
        <p className="text-base md:text-2xl mb-8">
          At Innovative Biscuits, our passionate team of forward-thinkers is
          driven to revolutionize the market—one delicious bite at a time. As a
          responsible organization, we stay committed to all our stakeholders,
          with a strong focus on our consumers.
        </p>
        <p className="text-base md:text-2xl mb-8">
          Guided by our mission to craft products that contribute to a better
          lifestyle and a stronger society, we continuously strive to raise
          industry standards. Through quality, taste, and innovation, we’ve
          carved our place in the hearts of our customers.
        </p>
        <p className="text-base md:text-2xl mb-8">
          To say we love what we do wouldn’t be enough—we live it, breathe it,
          and bake it into every biscuit.
        </p>
      </div>
