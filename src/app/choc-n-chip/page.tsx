...
import chocChipTestimonial from '../../assets/Choc n Chip.webp';
        ...
        <div
          className="w-full bg-[#87d9eb] text-[#054e9c]">
              ...
              <div className="relative flex flex-col px-10 md:px-58 mt-12 md:mt-25 mb-12 md:mb-25">
                  ...
                  <div className="text-base md:text-2xl text-left">{`Crunchy Edges, Irresistible Chips, and that just-right Sweetness - everything you love in a chocolate chip biscuit.`}</div>
                  <div className="flex mt-5 md:mt-10">
                    ...
                    <div className="flex justify-center z-10">
                        <div className="w-full mt-5 md:mt-20 md:px-20 flex justify-center">
                          <table className="w-full  max-w-[900px] text-center border-spacing-y-2 text-black">
                            <thead>
