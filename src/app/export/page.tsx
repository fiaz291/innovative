...
import heroImg from "../../assets/Export-World-Map.png";
    ...
    <div className="bg-[#efeff0]">
      ...
      <div className="p-10 max-w-7xl mx-auto flex gap-10">
        <div>
          ...
          <a
            className="underline text-blue-600 md:text-xl"
            href="https://www.exportbrochure-innovativebiscuits.com/"
          >
            Brochure
          </a>
        </div>
      ...
      <div className="p-10 pb-4 md:pb-10 max-w-7xl mx-auto">
        <h1 className="text-xl md:text-4xl font-black mb-6 decoration-blue-600">
          For Export Queries
        </h1>
        <form onSubmit={() => {}} className="space-y-4 pb-10 md:pb-20">
