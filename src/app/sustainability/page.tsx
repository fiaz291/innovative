...
export default function CareerPage() {
    ...
    <div>
        ...
        <div className='flex flex-col my-15 md:m-30'>
            ...
            <div className='text-xl md:text-4xl whitespace-pre-line text-center font-black'>{`Taking the Message to Classrooms`}</div>
            <p className='text-base md:text-2xl my-10 px-5 md:px-25 text-center'>Because learning happens best where curiosity lives, Jumbo Junior goes beyond the screen and into <strong>schools across Pakistan.</strong> Through interactive sessions and on-ground activities, we’re helping students understand how small actions today lead to a greener, cleaner tomorrow.</p>
        ...
        <div className='flex flex-col'>
            <div className='text-xl md:text-4xl whitespace-pre-line text-center font-black'>{`A Greener Future, One Step at a Time`}</div>
