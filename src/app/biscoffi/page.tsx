...
import biscoffiText from "../../../public/PremiumLogos/Biscoffi.webp";
    ...
    <div className="overflow-hidden">
      <div className="relative w-full bg-[#ffce54] pb-30">
        ...
        <div className="flex flex-col items-center px-10 md:px-30">
          <Image
            src={biscoffiSmallBean}
            alt="small-bean"
            className="absolute w-[6%] top-30 md:top-50 right-5 md:right-20"
          />
          <Image
            src={havenCoffeeBean}
            alt="bean"
            className="absolute w-[10%] top-40 md:top-90 left-[-10px] md:left-[-30px]"
          />
          <Image
            src={biscoffiText}
            alt="digestive-copy"
          ...
          <div className="flex">
            <div className="md:px-40">
              <div className="text-lg md:text-4xl leading-4 md:leading-[2rem] text-center mt-6 mb-6">
                <span className="text-base md:text-2xl leading-4 md:leading-[2rem]">{`Brewed to be Eaten - Artisan Crackers Infused with Rich Coffee Notes, toasted to a Delicate, Satisfying Crisp.`}</span>
              </div>
